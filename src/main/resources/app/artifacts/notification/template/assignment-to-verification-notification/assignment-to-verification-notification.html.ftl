...
<head>
    ...
    <title>Необходимо проверить поручение</title>
    <style>
        body {
...
<body>
<div class="container">
    <div class="header">Необходимо проверить поручение</div>
    <div class="content">
        ...
        <div class="executor-action">
            <p><strong>Исполнитель</strong> <i>${performer!""}</i> завершил(а) работу над поручением.</p>
            <p>Пожалуйста, проверьте и примите выполненное поручение.</p>
        </div>
